    ...
    for bag in bags:
        ...
        for data in bag:
            ...
            if ((max_sent_length < 0) or (len(words) <= max_sent_length)) and (len(words)>0):
                ...
                bag_texts.append([words, biwords, chars, gazs, temp_labels])
                bag_Ids.append([word_Ids, biword_Ids, char_Ids, gaz_Ids, [label_alphabet.get_index(label) for label in temp_labels]])
